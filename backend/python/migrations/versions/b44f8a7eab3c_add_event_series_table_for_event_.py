"""add event_series table for event recurrence

Revision ID: b44f8a7eab3c
Revises: b2c0597042a8
Create Date: 2026-07-28 02:33:00.608255
...
revision = 'b44f8a7eab3c'
down_revision = 'b2c0597042a8'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    op.add_column('events', sa.Column('end_time', sa.TIMESTAMP(), autoincrement=False, nullable=False))
    op.add_column('events', sa.Column('event_type', sa.UUID(), autoincrement=False, nullable=True))
    op.add_column('events', sa.Column('start_time', sa.TIMESTAMP(), autoincrement=False, nullable=False))
