...
from . import confirmation_request_routes, entity_routes, registration_routes, simple_entity_routes, user_routes
...
def init_app(app: FastAPI) -> None:
    ...
    app.include_router(confirmation_request_routes.router)
